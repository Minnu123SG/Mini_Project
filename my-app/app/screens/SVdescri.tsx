  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Image
          source={{
            uri: "https://5.imimg.com/data5/JX/CT/ME/SELLER-12550568/hostel-bed.jpg",
          }}
        ...
        <View style={styles.detailsContainer}>
          ...
          <Text style={styles.subtitle}>Boys Hostel</Text>
          ...
          <Text style={styles.info}>💰 INR 6500 per month</Text>
      ...
      <Modal transparent visible={isModalVisible} animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalText}>Waiting: 1</Text>
          </View>
        </View>
      </Modal>
      ...
      <Modal transparent visible={isBookingModalVisible} animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalText}>Successfully Booked</Text>
          </View>
        </View>
      </Modal>
    </View>
